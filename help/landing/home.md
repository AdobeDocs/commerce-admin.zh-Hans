...
description: 搜索有关Adobe Commerce Admin的自助文章和教程。 在配置、管理和排查Commerce商店故障方面获得专家支持。
...
有关Adobe Commerce中包含的高级功能的列表，请参阅&#x200B;_发行信息_&#x200B;中的[Commerce功能](https://experienceleague.adobe.com/zh-hans/docs/commerce-operations/release/features)。
...
<tr>
  <td valign="top">
   ...
   <td valign="top"><a href="../b2b/guide-overview.md"><strong>Adobe Commerce B2B</strong></a> [!BADGE PaaS only]{type=Informational url="https://experienceleague.adobe.com/zh-hans/docs/commerce/user-guides/product-solutions" tooltip="仅适用于云项目上的Adobe Commerce （Adobe管理的PaaS基础结构）和内部部署项目。"}
...
<tr>
   ...
   <td valign="top"><a href="../merchandising-promotions/guide-overview.md"> <strong>促销活动</strong></a>
...
<tr>
   ...
   <td valign="top"><a href="../content-design/guide-overview.md"> <strong>内容和设计</strong></a>
...
<tr>
   ...
   <td valign="top"><a href="../page-builder/guide-overview.md"> <strong>[!DNL Page Builder]</strong></a> [!BADGE PaaS only]{type=Informational url="https://experienceleague.adobe.com/zh-hans/docs/commerce/user-guides/product-solutions" tooltip="仅适用于云项目（Adobe管理的PaaS基础结构）和本地项目上的Adobe Commerce。"}
...
<tr>
   ...
   <td valign="top"><a href="../customers/guide-overview.md"> <strong>客户管理</strong></a>
...
<tr>
   ...
   <td valign="top"><a href="../stores-purchase/guide-overview.md"> <strong>存储和购买体验</strong></a>
...
<tr>
   ...
   <td valign="top"><a href="../systems/guide-overview.md"> <strong>管理系统</strong></a>
...
<tr>
   ...
   <td valign="top"><a href="../configuration-reference/guide-overview.md"> <strong>配置引用</strong></a>
