...
1. [[!DNL Audience Activation]](https://experienceleague.adobe.com/zh-hans/docs/commerce-admin/customers/audience-activation)：使用[!DNL Real-Time CDP]受众在Adobe [!DNL Commerce]网站上个性化动态内容块、促销活动和相关产品规则。
