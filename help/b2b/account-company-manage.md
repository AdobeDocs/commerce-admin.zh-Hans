---
title: 管理公司帐户
description: 了解“公司”页面以及网格中可用的工具，这些工具可帮助您管理Adobe Commerce商店的公司帐户。
...
使用 _[!UICONTROL Search]_函数以查找以下位置中的公司：**公司**按关键字网格。 它将通过在指定的关键字中搜索来查找公司&#x200B;**公司名称**和&#x200B;**父级**列。 您可以按以下项过滤&#x200B;**公司类型**显示母公司及其关联公司，或仅显示子公司。
...
1. 设置 **[!UICONTROL Actions]** 控制对象 `Set Active`.
...
1. 在 _操作_ 最右侧的列，单击 [!UICONTROL **编辑**].
...
1. 设置 **[!UICONTROL Actions]** 控制对象 `Block`.
...
1. 设置 **[!UICONTROL Actions]** 控制对象 `Convert Currency`.
...
| [!UICONTROL Reason for Change] | 说明公司允许或不允许超出信用限额原因的注释。 仅当超出信用限制的权限发生变化时，此字段才处于活动状态。 |
