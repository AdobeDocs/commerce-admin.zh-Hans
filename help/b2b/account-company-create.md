...
![从管理员添加新公司](./assets/company-add-new.png){width="700" zoomable="yes"}
...
| [!UICONTROL Group/Shared Catalog] | （仅限管理员）指示 [客户组](../customers/customer-groups.md) 或 [共享目录](catalog-shared.md) 分配给公司的属性。 |
