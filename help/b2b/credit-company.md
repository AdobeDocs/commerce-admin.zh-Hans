...
* **Supply chain合作伙伴** — 需要信贷机制的分销商、转销商和渠道合作伙伴
...
| [!UICONTROL Comment] | 根据操作类型，`Reason for Change`字段中的值的编译。<br/>**[!UICONTROL Purchased]**— 包含购买评论、订单编号和订单链接。<br/>**[!UICONTROL Reimbursed]** — 包含报销交易记录的注释。 |
