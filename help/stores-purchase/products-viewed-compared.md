...
1. 展开![部分的](../assets/icon-display-expand.png)扩展选择器&#x200B;**[!UICONTROL Recently Viewed/Compared Products]**。
   ...
   有关这些配置设置的详细说明，请参阅[配置参考指南](../configuration-reference/catalog/catalog.md#recently-viewedcompared-products)中的&#x200B;_最近查看/比较的产品_。
