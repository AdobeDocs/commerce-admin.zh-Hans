...
控制页面布局和块放置的代码以XML格式编写 [小组件](widgets.md). 利用这些小组件，可以轻松地将块放置在页面上的特定位置，甚至对于特定产品或类别也是如此，而无需编写任何代码。 您可以从列表中选择每个选项，而不是尝试记住所有可能的组合。
...
| [!UICONTROL My Cart Extra Actions] | 内容显示在 _购物车小计_ 客户单击页面顶部的购物车图标时。 |
...
| [!UICONTROL Bottom Block Options Wrapper] | 如果添加了自定义选项，内容将显示在 _添加到购物车_ 按钮。 |
...
| [!UICONTROL Page Header] | 内容显示在页面标题的下方。 |
| [!UICONTROL Page Top] | 内容显示在页面顶部。 |
| [!UICONTROL PayPal Express Checkout (Payflow Edition) Shortcut Wrapper] | 如果启用了PayPal支付方式，则内容将显示在 _PayPal购买_ 按钮。 |
| [!UICONTROL PayPal Express Checkout Shortcut Wrapper] | 如果启用了PayPal支付方式，则内容将显示在 _PayPal购买_ 按钮。 |
...
| [!UICONTROL Tags List Before] | 内容显示在上方 _[!UICONTROL Add Your Tags]_字段。 |
