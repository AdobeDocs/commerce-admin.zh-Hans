...
>[!NOTE]
>
>新[!DNL Media Gallery]的完整功能要求启动`media.gallery.synchronization`和`media.content.synchronization`队列使用者进行初始同步。 有关详细信息，请参阅[配置指南](https://experienceleague.adobe.com/docs/commerce-operations/configuration-guide/message-queues/manage-message-queues.html?lang=zh-Hans)中的&#x200B;_管理消息队列_。

## 访问新[!DNL Media Gallery]

可从“内容”菜单或当您[!DNL Media Gallery]添加或编辑页面[时访问新](/help/content-design/page-add.md)。 在[创建或编辑类别](/help/catalog/category-create.md)时，或者在使用内容编辑器[插入图像时](/help/content-design/editor-insert-image.md)，也可以访问该内容。

要通过[!UICONTROL Media Gallery]菜单访问新[!UICONTROL Content]：
