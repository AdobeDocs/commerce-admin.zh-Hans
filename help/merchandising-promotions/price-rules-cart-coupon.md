...
创建[购物车价格规则](price-rules-cart.md)后，您可以手动将自定义优惠券代码添加到该规则中。

1. 在&#x200B;_管理员_&#x200B;侧边栏中，转到&#x200B;**[!UICONTROL Marketing]** > _[!UICONTROL Promotions]_>**[!UICONTROL Cart Price Rules]**，然后选择要将自定义优惠券代码添加到的规则。

1. 展开&#x200B;**[!UICONTROL Manage Coupon Codes]**&#x200B;部分，然后单击&#x200B;**[!UICONTROL Add Coupon Code]**。

   ![自定义优惠券代码](./assets/custom-coupon-codes.png){width="600" zoomable="yes"}

1. 在&#x200B;**[!UICONTROL Add Custom Coupon]**&#x200B;对话框中，输入要用于购物车价格规则的优惠券代码，然后单击&#x200B;**[!UICONTROL Save]**。

   ![添加优惠券代码](./assets/add-custom-coupon.png){width="600" zoomable="yes"}

1. 单击&#x200B;**[!UICONTROL Save]**&#x200B;以更新购物车价格规则。

要删除自定义优惠券代码，请在网格中选择要删除的代码，然后从&#x200B;**[!UICONTROL Actions]**&#x200B;选择器中选择&#x200B;**[!UICONTROL Delete]**。
...
![编辑优惠券代码](./assets/edit-coupon-code.png){width="600" zoomable="yes"}

#### 批量导入自定义优惠券代码

如果您有预定义优惠券代码的列表，则可以从CSV文件将它们附加到购物车价格规则，而不是单独添加每个代码。 CSV文件应仅包含一列带有优惠券代码的文件。

1. 在&#x200B;_管理员_&#x200B;侧边栏中，转到&#x200B;**[!UICONTROL Marketing]** > _[!UICONTROL Promotions]_>**[!UICONTROL Cart Price Rules]**，然后选择要将自定义优惠券代码导入到的规则。

1. 展开&#x200B;**[!UICONTROL Manage Coupon Codes]**&#x200B;部分，然后单击&#x200B;**[!UICONTROL Import]**。

   >[!NOTE]
   >
   >**[!UICONTROL Import]**&#x200B;按钮在已保存的购物车价格规则上可用，其中&#x200B;**[!UICONTROL Coupon]**&#x200B;设置为`Specific Coupon`且&#x200B;**[!UICONTROL Use Auto Generation]**&#x200B;已关闭。

1. 在&#x200B;**[!UICONTROL Import Coupons]**&#x200B;对话框中，单击&#x200B;**[!UICONTROL Choose File]**&#x200B;并选择包含要导入的优惠券代码的CSV文件。
   ...
   选择文件后，对话框显示一个&#x200B;**[!UICONTROL Preview]**，其中显示了准备导入的代码数以及来自文件的第一个代码的示例。

   ![导入优惠券对话框](./assets/import-custom-coupons.png){width="600" zoomable="yes"}

1. 单击&#x200B;**[!UICONTROL Import]**。 该对话框显示一个摘要，其中包含已排队等候导入的代码数以及已跳过的现有代码列表。
...
| [!UICONTROL Cart Price Rules] | 确定报表中包含哪些优惠券促销活动。 选项： <br/>**[!UICONTROL Any]**：包含在指定日期范围内使用的任何优惠券促销的订单信息。<br/>**[!UICONTROL Specified]**：仅包含在指定日期范围内选定优惠券促销的订单信息。 |
