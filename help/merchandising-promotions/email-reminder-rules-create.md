...
选中&#x200B;**[!UICONTROL General Information]**&#x200B;选项卡上的&#x200B;**[!UICONTROL Rule Repeatability]**&#x200B;复选框，可在原始规则触发器不再应用后，再次将规则应用于用户。
