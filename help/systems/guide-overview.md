...
| [数据传输](data-transfer.md) | <ul><li>通过导入和导出工具，您能够在一次操作中管理多个记录。 您不仅可以导入新项目，还可以更新、替换和删除现有产品集。</li><li>查看从[[!UICONTROL Data Management Dashboard]](data-dashboard.md)传送到连接的Commerce服务的实体的数据同步状态。</li><li>监视从[[!UICONTROL Data Feed Sync Status]](data-feed-sync-status.md)页面将数据馈送导出到Commerce SaaS服务的同步状态。</li></ul> |
