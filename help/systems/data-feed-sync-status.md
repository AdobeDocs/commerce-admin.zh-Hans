...
* 对于使用[Adobe Commerce Optimizer Connector](https://experienceleague.adobe.com/en/docs/commerce/aco-optimizer-connector/overview)配置的Adobe Commerce云上或本地部署，请在Commerce Optimizer Studio中检查[数据同步页面](https://experienceleague.adobe.com/en/docs/commerce/optimizer/setup/data-sync)。
...
>[!NOTE]
>
>您不需要在[[!DNL Adobe Commerce as a Cloud Service]](https://experienceleague.adobe.com/en/docs/commerce/cloud-service/overview)实例上安装数据馈送状态扩展。
...
>[!MORELIKETHIS]
>
>* [数据管理仪表板](https://experienceleague.adobe.com/en/docs/commerce-admin/systems/data-transfer/data-sync/data-dashboard)
