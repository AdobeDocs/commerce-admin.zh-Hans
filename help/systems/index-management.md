...
1. 单击 **[!UICONTROL Submit]** 将更改应用于每个选定的索引器。
   ...
   **“索引管理”列**
   ...
   | [!UICONTROL Status] | 显示以下选项之一： <br/>**[!UICONTROL Ready]**— 索引是最新的。<br/>**[!UICONTROL Scheduled]**  — 计划重新编制索引。 <br/>**[!UICONTROL Running]**— 正在重新编制索引。<br/>**[!UICONTROL Reindex Required]**  — 已做出需要重新索引的更改，但索引器无法自动更新。 检查以查看 [cron](cron.md) 可用且配置正确。 |
