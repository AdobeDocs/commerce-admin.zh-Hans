...
1. 在&#x200B;_[!UICONTROL Roles Resources]_&#x200B;下，将&#x200B;**[!UICONTROL Resource Access]**&#x200B;设置为`Custom`。
   ...
   >[!NOTE]
   >
   >如果需要双重身份验证(2FA)才能登录到管理员，请确保为此角色启用资源`Permissions` > `Two Factor Auth`。 否则，新创建的具有此`Custom`角色范围的用户在首次访问管理员时无法设置2FA。
...
|  | `Sales Channel` | [`Amazon Sales Channel`](https://experienceleague.adobe.com/zh-hans/docs/discontinued/using/commerce-channels) |
...
|  | `System Insights` ![Adobe Commerce](../assets/adobe-logo.svg) | [`Site-Wide Analysis Tool`](https://experienceleague.adobe.com/zh-hans/docs/commerce-operations/tools/site-wide-analysis-tool/access) |
