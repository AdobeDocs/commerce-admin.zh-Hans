...
<table style="table-layout:auto;">
  ...
  <tbody>
    <tr>
      <td><p>更新了<a href="https://experienceleague.adobe.com/zh-hans/docs/commerce-admin/start/compliance/privacy/compliance-cookie-law">Cookie合规性</a>以添加缺少的<code class="language-plaintext highlighter-rouge">mage-cache-timeout</code>本地Storage密钥并将免税Cookie列表转换为表格式。</p>
</td>
      <td>
        技术，反馈
      </td>
