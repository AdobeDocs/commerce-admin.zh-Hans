...
使用[!DNL Page Builder]面板的&#x200B;_[!UICONTROL Elements]_部分将文本、标题、按钮、分隔符和HTML代码添加到[[!DNL Page Builder] 阶段](workspace.md#stage)上的任何布局容器中。 将内容类型从面板拖到行或列，或者拖到舞台上的选项卡集时，会显示一个容器。 使用内容类型工具箱访问特定于类型的设置。
