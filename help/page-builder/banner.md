...
使用&#x200B;_Banner_&#x200B;内容类型在[[!DNL Page Builder] 阶段](workspace.md#stage)中添加一个带插图的交互式组件，该组件让用户能够看到行动号召和按钮。
...
1. 在[!DNL Page Builder]面板中，展开&#x200B;**[!UICONTROL Media]**&#x200B;并将&#x200B;**[!UICONTROL Banner]**&#x200B;占位符拖到舞台上。
   ...
   已包含&#x200B;_[!UICONTROL Upload Image]_&#x200B;和_[!UICONTROL Select from Gallery]_&#x200B;按钮，因此您可以直接从舞台快速更改横幅内容。 您还可以更改&#x200B;_[!UICONTROL Edit Banner]_&#x200B;页面上的内容。
