...
如果您需要[提交您的第一个支持票证](https://experienceleague.adobe.com/zh-hans/docs/commerce-knowledge-base/kb/help-center-guide/magento-help-center-user-guide#support-case)，或在特定店面之外处理您的Adobe Commerce关系，请先创建或访问您的[!DNL Commerce]帐户。
