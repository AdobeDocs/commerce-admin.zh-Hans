...
![复选框](../assets/checkbox.png)  — 不要对系统密码和其他安全参数使用供应商提供的默认值。

![复选框](../assets/checkbox.png) - Protect存储的持卡人数据。

![复选框](../assets/checkbox.png)  — 加密持卡人数据在开放的公共网络上的传输。

![复选框](../assets/checkbox.png)  — 使用和定期更新防病毒软件。

![复选框](../assets/checkbox.png)  — 开发和维护安全的系统和应用程序。

![复选框](../assets/checkbox.png)  — 根据业务要求限制对持卡人数据的访问。

![复选框](../assets/checkbox.png)  — 为具有计算机访问权限的每个人分配一个唯一ID。

![复选框](../assets/checkbox.png)  — 限制对持卡人数据的实际访问。

![复选框](../assets/checkbox.png)  — 跟踪和监控对网络资源和持卡人数据的所有访问。

![复选框](../assets/checkbox.png)  — 定期测试安全系统和流程。

![复选框](../assets/checkbox.png)  — 维护解决信息安全问题的策略。
