...
当您将&#x200B;**[!UICONTROL Store View]**&#x200B;选择器切换到特定的存储视图（而不是&#x200B;**[!UICONTROL All Store Views]**）时，_[!UICONTROL Images and Videos]_&#x200B;部分提供了额外的控件，用于管理如何为该存储视图显示图像，而不会影响默认范围。

### 为商店视图重新排序图像

在商店视图范围中工作时，_[!UICONTROL Images and Videos]_&#x200B;框下方会显示&#x200B;**[!UICONTROL Use Default Order]**&#x200B;复选框。 选中此复选框可将图像显示顺序还原为在默认范围中定义的顺序。
