...
| [!UICONTROL Page Builder]仅[!BADGE PaaS]{type=Informative url="https://experienceleague.adobe.com/en/docs/commerce/user-guides/product-solutions" tooltip="仅适用于云项目（Adobe管理的PaaS基础架构）和内部部署项目上的Adobe Commerce 。"} | 位于属性位置的[[!DNL Page Builder]](../page-builder/workspace.md)工作区，可轻松将吸引人的内容添加到产品页面。 |
