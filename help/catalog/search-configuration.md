...
目录搜索配置有两种变体。 第一种方法描述了安装[实时搜索](https://experienceleague.adobe.com/en/docs/commerce/live-search/overview)时可用的设置。 第二种方法描述了使用[OpenSearch](https://experienceleague.adobe.com/en/docs/commerce-operations/installation-guide/prerequisites/search-engine/overview){:target="_blank"}的本机Adobe Commerce的配置设置。

>[!NOTE]
>
>有关云基础架构项目，请参阅&#x200B;[_Commerce on Cloud Infrastructure指南_](https://experienceleague.adobe.com/en/docs/commerce-on-cloud/user-guide/configure/service/opensearch)中的其他说明。
...
1. 要更改[店面弹出窗口](https://experienceleague.adobe.com/en/docs/commerce/live-search/overview)中返回的结果可用的最大行数，请输入其他&#x200B;**[!UICONTROL Autocomplete Limit]**&#x200B;值。
...
>[!IMPORTANT]
>
>- 由于[!DNL Elasticsearch 7]将于2023年8月终止支持公告，建议所有Adobe Commerce客户迁移到OpenSearch 2.x搜索引擎。 有关在产品升级期间迁移搜索引擎的信息，请参阅&#x200B;_升级指南_&#x200B;中的[迁移到OpenSearch](https://experienceleague.adobe.com/en/docs/commerce-operations/upgrade-guide/prepare/opensearch-migration)。
