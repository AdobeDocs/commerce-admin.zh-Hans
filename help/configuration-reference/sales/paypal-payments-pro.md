...
![必需的设置](./assets/payment-methods-paypal-payments-pro-required.png)<!-- zoom -->
...
| [!UICONTROL Use Proxy] | 网站 | 当服务器防火墙阻止直接访问PayPal服务器时，可以使用代理重定向流量。 如果适用，则标识用于与PayPal服务器建立连接的代理服务器。 选项： `Yes` / `No` <br/><br/>如果启用，请设置选项： <br/>**代理主机** — 代理主机的IP地址。 <br/>**代理端口** — 代理端口的编号。 |
...
![基本设置](./assets/payment-methods-paypal-payments-pro-basic-settings.png)<!-- zoom -->
...
![高级设置](./assets/paypal-advanced-settings.png)<!-- zoom -->
...
| [!UICONTROL AVS Street Does Not Match] | 网站 | 确定地址验证服务确定街道地址与系统中的信息不匹配时所采取的操作。 选项： `Yes` / `No` |
| [!UICONTROL AVS Zip Does Not Match] | 网站 | 确定在地址验证服务确定邮政编码与系统中的信息不匹配时执行的操作。 选项： `Yes` / `No` |
...
![PayPal Express签出基本设置](./assets/payment-methods-paypal-payments-pro-express-checkout-basic-settings.png)<!-- zoom -->
...
![PayPal Express签出高级设置](./assets/payment-methods-paypal-payments-pro-express-checkout-advanced-settings.png)<!-- zoom -->
