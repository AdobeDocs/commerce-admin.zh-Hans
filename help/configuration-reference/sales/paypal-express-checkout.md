...
![PayPal Express签出必需设置](./assets/paypal-express-required-settings.png)<!-- zoom -->
...
| [!UICONTROL Home Page] | 网站 | 确定 [!DNL PayPal Credit] 标题栏目中。 选项： <br/>**显示**  — 显示[!DNL PayPal Credit] 您商店的主页上的横幅。 选项： `Yes` / `No` <br/>**位置**  — 确定 [!DNL PayPal Credit] 标题栏目中。 选项：标题（中心）/侧栏（右） <br/>**大小**  — 确定 [!DNL PayPal Credit] 标题栏目中。 选项： `190 x 100` / `234 x 60` / `300 x 50` / `468 x 60` / `728 x 90` /` 800 x 66` |
...
| [!UICONTROL Sort Order] | 商店视图 | 在结帐期间与其他付款方法一起列出时，用于确定PayPal Express结帐顺序的编号。 输入 `0` ，在列表顶部。 |
