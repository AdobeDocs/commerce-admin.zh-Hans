...
>[!NOTE]
>
>若要使用旧版配置而不是[设置](https://experienceleague.adobe.com/docs/commerce/payment-services/configure/settings.html)，请参阅[旧版配置](https://experienceleague.adobe.com/docs/commerce/payment-services/configure/configure-admin.html?lang=zh-Hans)。
