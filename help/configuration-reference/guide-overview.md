...
本指南面向使用Adobe Commerce或Magento Open Source Admin的商家和系统管理员。 它提供从&#x200B;_>_ > **[!UICONTROL Stores]**&#x200B;的&#x200B;_[!UICONTROL Settings]_管理员&#x200B;**[!UICONTROL Configuration]**侧边栏访问的所有商店配置设置的参考信息。
